...
namespace DownloaderSeriesWithSeasonvar.Core.Tests
{
    ...
    public class SeasonTest
    {
        ...
        {
            // Arrage
            var firstObj = new Season("FirstObj", null);
            firstObj.SeriesList = new List<Series>()
            {
                new Series("FirstObj", new Uri("http://FirstObj.ru"), 1, 3)
            };
            var secondObj = new Season("FirstObj", null);
            secondObj.SeriesList = new List<Series>()
            {
                new Series("FirstObj", new Uri("http://FirstObj.ru"), 1, 3)
            };
        ...
        [TestMethod]
        public void SeriesList_JsonPlaylist_CorrectSeasonObject()
        {
            // Arrage
            ...
            var correctConvertSeason = new Season("Dr. Horrible's Sing-Along Blog", null);
            correctConvertSeason.SeriesList = new List<Series>()
            {
                new Series(
                    "Dr. Horrible's Sing-Along Blog Серия 1",
                    ...
                    1),
                new Series(
                    "Dr. Horrible's Sing-Along Blog Серия 2",
                    ...
                    2),
                new Series(
                    "Dr. Horrible's Sing-Along Blog Серия 3",
            ...
            // Act
            result = new Season("Dr. Horrible's Sing-Along Blog", correctJsonPlaylist);
